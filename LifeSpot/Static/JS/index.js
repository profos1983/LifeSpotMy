...
//Напишите код, чтобы при входе на тестовую страницу localhost: 5000 / testing сайт спрашивал бы
//ваше имя, а в ответ выводил само имя и то, сколько символов в нём.

let userName = prompt("Пожалуйста, введите Ваше имя");
alert(userName + ", преветсвуе на LifeSpot! \nКоличество символов в Вашем имени: " + userName.length);